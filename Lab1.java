...
class TH5 {
	...
	public static void main(String[] args) throws Exception {
		...
		do
		{
			...
			case 1:				
				try {
					nhapDuLieu();
					System.out.println("Da them phong hoc!");
	...
	public static int menu()
	{
		...
		System.out.println("4.  In thông tin phong hoc co so may tinh    ##");
		...
		System.out.println("12. Tim kiem phong học                      ##");
	...
	public static void capNhatSoMayTinh() throws Exception
	{
		...
		else if(phTim instanceof PhongMayTinh)
		{
			...
			System.out.println("Thong tin phong hoc sau khi da cap nhat:");
			xuatTieuDePhongMT();
			System.out.println(phTim);
			inGachNgang1();
		}
